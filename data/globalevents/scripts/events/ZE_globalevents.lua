...
local function ZE_Verifica()
	...
	if tile then
		...
		if item then
			...
			broadcastMessage("The Zombie Event was opened and will be closed in ".. ZE.tpTimeOpen .." minutes.", MESSAGE_STATUS_WARNING)
...
local function warnEvents(i)
	Game.broadcastMessage("The Zombie event was opened, entrance through Temple of Thais!")
	if i > 1 then
