...
function onThink(interval, lastExecution)
    local MESSAGE = {
        ...
        "[TIBIA CLIENTS COMPATIVEIS]  10.00 e 11.32",
        "[BUGS?] REPORTEM EM: http://www.github.com/malucooo/otxserver-new/.",
        "[FEATURES] NEW DEPOT, NEW SPAWN, NEW CAST SYSTEM, NEW NPC SYSTEM VIA BANK BALANCE, NEW CRITICAL BOOST SYSTEM, NEW POTIONS, REWARD SYSTEM, PREY SYSTEM, IMBUEMENT SYSTEM, INSPECTION SYSTEM, CASKS AND KEGS, FULL GLOBAL MAP WITH HALLS OF ROPE, WAR ANTIENTROSA, BATTLEFIELD, CAPTURE THE FLAG, LAST STANDING MAN AND ZOOMBIE EVENT.",
		"[AGRADECIMENTO] TODOS QUE COLABORAM DIARIAMENTE MOSTRANDO E CORRIGINDO BUGS E PRINCIPALMENTE E MAIS UMA VEZ A TODOS QUE ACREDITARAM E ACREDITAM NO PROJETO.",
